...
class Activation1d(nn.Module):
    def __init__(self,
        ...
        self.act = activation
        self.upsample = UpSample1d(up_ratio, up_kernel_size, channels=channels)
        self.downsample = DownSample1d(down_ratio, down_kernel_size, channels=channels)
...
class SynthesizerTrn(nn.Module):
    def __init__(self, spec_channels, segment_size, resblock, resblock_kernel_sizes, resblock_dilation_sizes, upsample_initial_channel):
        super().__init__()
