...
3.  **Build Size Reduction:** Optimizing the standalone executable size by pruning dependencies and enabling compression.
    -   Detailed Task: [Build Size Reduction](docs/tasks/build_size_reduction.md)
