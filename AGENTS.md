...
## Project Overview
Wavoscope is a musician-oriented audio transcription workbench. It is a web-based application with a FastAPI (Python) backend and a React (Vite) frontend.

## Major Accomplishment: GUI Migration Complete
We have successfully replaced the legacy Qt-based interface with a browser-based GUI. The project is now lighter and more portable.
