...
- [x] **3. `frontend/src/store/useStore.ts`**
...
## Implementation Plan
- [x] Identify and isolate logical boundaries within each monolithic script.
- [x] Extract shared types and utilities into common modules.
- [x] Refactor scripts one by one, ensuring all tests pass after each split.
- [x] Update imports across the entire project to reflect the new structure.
