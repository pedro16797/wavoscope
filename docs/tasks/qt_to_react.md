...
-   [ ] Implement efficient data streaming for waveform and spectrum data.
-   [ ] Test the UI on different browsers.

### 5. Packaging & Distribution
-   [ ] Determine the best way to bundle the application (e.g., PyInstaller with a bundled web server, or using a lightweight webview like `pywebview`).
-   [ ] Update the build process to include the frontend assets.
