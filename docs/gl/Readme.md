...
- **Volume e Overdrive:** Axusta o volume xeral co deslizador. Fai clic na **icona de volume** ou preme `G` para alternar o **modo Overdrive**, que estende o rango de volume do 100% ao 200%. A aplicación lembra niveis de volume independentes para os modos normal e overdrive.
